...
<link rel="icon" type="image/svg+xml" href="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 64 64'%3E%3Ccircle cx='32' cy='32' r='27' fill='%235B3FC8'/%3E%3C/svg%3E">
<style>
  ...
  * {{ box-sizing: border-box; }}
  ...
  /* ── DISCLAIMER (ganz oben, prominent) ── */
  .disclaimer {{
    background: #FEF3E2; border-bottom: 2px solid #F5CC80;
    padding: 14px 24px; font-size: 12.5px; color: #7A5500; line-height: 1.55;
  }}
  .disclaimer strong {{ font-weight: 700; }}
  .disclaimer a {{ color: #7A5500; text-decoration: underline; }}
  ...
  .mv-detail {{
    ...
    box-shadow: var(--shadow); padding: 18px 20px; margin-bottom: 14px; scroll-margin-top: 90px;
  }}
  .mv-detail-head {{
  ...
  @media (max-width: 700px) {{
    ...
    .contact-section, footer {{ margin-left: 16px; margin-right: 16px; padding-left: 0; padding-right: 0; }}
  }}
</style>
</head>
<body>
